...
export default function Hero() {
  ...
  // Scroll animations for the 3D Zoom Out effect
  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: ["start start", "end start"]
  });

  // Smooth out the scroll interpolation
  ...
  // As user scrolls down, we map to [0, 0.5] because the Projects section will overlay 
  // starting from the halfway point. This completely eliminates empty dead space.
  const scale = useTransform(smoothProgress, [0, 0.5], [1, 5]);
  const opacity = useTransform(smoothProgress, [0, 0.3, 0.45], [1, 0, 0]);
  const yOffset = useTransform(smoothProgress, [0, 0.5], ['0%', '50%']); // Push down slightly as it scales
    ...
    <>
      ...
      <section ref={containerRef} className="relative h-[150vh] md:h-[200vh] w-full max-w-full overflow-x-clip z-0 snap-start">
        ...
        <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
          ...
          {/* Main Content Container tied to scroll transforms */}
          <motion.div
          ...
          >
            {/* Animated background elements inside the scalable container */}
            <motion.div
            ...
            <div className="relative z-10 text-center md:text-left p-6 md:p-12 w-[95%] md:w-[90%] max-w-7xl mx-auto">
              <motion.div
              ...
              >
                Computer Science graduate who loves making beautiful apps...
              </motion.h2>
